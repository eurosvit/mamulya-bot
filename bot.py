...
MIGRATE_TEXT = ("<b>Великі новини від Mamulya! 🎉</b>\n\n"
    "Ми оновились і переїхали в нового помічника — розумнішого і щедрішого 💗\n\n"
    "Що нового:\n"
    "🎁 <b>Подарунки за кожне замовлення</b> — на вибір: −20% на аналізи в лабораторії Dila, купони на наступні покупки, безкоштовна доставка\n"
    "💎 <b>Єдина програма лояльності</b> — покупки в Mamulya, Modnamama, Znana Mama та Lipoland складаються в одну суму і відкривають постійну знижку до 10%. Усе, що ви купували раніше, вже зараховано!\n"
